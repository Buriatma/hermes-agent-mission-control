...
export function ConditionalLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen">
      ...
      <Sidebar />
      <main className={`relative flex-1 page-enter overflow-auto pt-16 md:pt-0 pb-20 md:pb-0 ${
        isChat ? 'px-0 py-0 md:p-2' : 'px-4 sm:px-6 md:px-10 lg:px-12 py-4 md:py-8'
      }`}>
